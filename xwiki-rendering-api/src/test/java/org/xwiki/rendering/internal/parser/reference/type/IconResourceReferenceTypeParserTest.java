...
/**
 * Unit tests for {@link IconResourceReferenceTypeParser}.
 *
 * @version $Id$
 * @since 5.1M1
 */
public class IconResourceReferenceTypeParserTest
{
    @Rule
    public MockitoComponentMockingRule<ResourceReferenceTypeParser> mocker =
        new MockitoComponentMockingRule<ResourceReferenceTypeParser>(IconResourceReferenceTypeParser.class);
