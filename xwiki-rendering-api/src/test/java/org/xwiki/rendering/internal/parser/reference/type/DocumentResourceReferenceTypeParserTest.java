...
/**
 * Unit tests for {@link DocumentResourceReferenceTypeParser}.
 *
 * @version $Id$
 * @since 5.1M1
 */
public class DocumentResourceReferenceTypeParserTest
{
    @Rule
    public MockitoComponentMockingRule<ResourceReferenceTypeParser> mocker =
        new MockitoComponentMockingRule<ResourceReferenceTypeParser>(DocumentResourceReferenceTypeParser.class);
