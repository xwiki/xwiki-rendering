...
/**
 * Unit tests for {@link MailtoResourceReferenceTypeParser}.
 *
 * @version $Id$
 * @since 5.1M1
 */
public class MailtoResourceReferenceTypeParserTest
{
    @Rule
    public MockitoComponentMockingRule<ResourceReferenceTypeParser> mocker =
        new MockitoComponentMockingRule<ResourceReferenceTypeParser>(MailtoResourceReferenceTypeParser.class);
