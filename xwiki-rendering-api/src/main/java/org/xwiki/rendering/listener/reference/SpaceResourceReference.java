...
public class SpaceResourceReference extends ResourceReference
{
    ...
    /**
     * @return the anchor name pointing to an anchor defined in the referenced space's WebHome doucment or null if no
     *         anchor has been specified (in which case the reference points to the top of the space's WebHome
     *         document). Note that in XWiki anchors are automatically created for titles. Example:
