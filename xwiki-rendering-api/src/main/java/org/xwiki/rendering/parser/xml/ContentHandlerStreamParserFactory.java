...
/**
 * Create instances of {@link ContentHandlerStreamParser}.
 *
 * @version $Id$
 * @since 3.3M1
 */
...
public interface ContentHandlerStreamParserFactory
{
    ...
    /**
     * @param listener the listener to send rendering events to
     * @return the new {@link ContentHandlerStreamParser} instance.
     */
