 ...
 */
@Role
public interface ContentHandlerStreamRendererFactory
{
    /**
     ...
     * @return the new {@link ContentHandlerStreamRenderer} instance.
     */
    ContentHandlerStreamRenderer createRenderer(ContentHandler contentHandler);
}
