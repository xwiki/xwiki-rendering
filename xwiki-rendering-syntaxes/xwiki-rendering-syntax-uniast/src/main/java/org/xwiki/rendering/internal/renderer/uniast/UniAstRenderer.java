...
public class UniAstRenderer extends AbstractChainingPrintRenderer implements Initializable
{
    @Inject
    ...
    public void initialize() throws InitializationException
    {
        ...
        chain.addListener(new UniAstChainingRenderer(this.resourceReferenceTypeSerializer, chain));
    }
}
