...
/**
 * Secure Block Renderer for XHTML syntax. To be used to convert XDOM into XHTML.
 *
 * @version $Id$
 * @since 5.1RC1
 */
...
@Singleton
public class SecureXHTMLBlockRenderer extends AbstractBlockRenderer
{
    /** Print Renderer Factory. */
    @Inject
    @Named("xhtml/1.0")
