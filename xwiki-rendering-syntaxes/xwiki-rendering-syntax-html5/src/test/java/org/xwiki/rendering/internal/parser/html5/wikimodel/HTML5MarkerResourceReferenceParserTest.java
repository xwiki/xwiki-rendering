 ...
 * @since 2.5RC1
 */
public class HTML5MarkerResourceReferenceParserTest extends AbstractComponentTestCase
{
    ...
    {
        this.parser = getComponentManager().getInstance(ResourceReferenceParser.class, "html5marker");
    }
