...
{
    private HTML5LinkRenderer linkRenderer;

    private HTML5ImageRenderer imageRenderer;
     ...
     */
    public HTML5ChainingRenderer(HTML5LinkRenderer linkRenderer, HTML5ImageRenderer imageRenderer,
