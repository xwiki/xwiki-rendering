...
public class DefaultHTML5ImageRenderer implements HTML5ImageRenderer, Initializable
{
    /**
     * @see #setXHTMLWikiPrinter(org.xwiki.rendering.renderer.printer.XHTMLWikiPrinter)
     */
     ...
     * {@inheritDoc}
     *
     * @see HTML5ImageRenderer#onImage(org.xwiki.rendering.listener.reference.ResourceReference , boolean, java.util.Map)
     * @since 2.5RC1
     */
    @Override
