 ...
 */
package org.xwiki.rendering.internal.parser.xwiki22.reference;
...
@Named("default/2.2")
@Singleton
public class XWiki22DefaultResourceReferenceParser extends AbstractDefaultResourceReferenceParser
{
    /**
     * The list of type parsers supported by the XWiki Syntax 2.2.
     */
