 ...
 * @since 14.1RC1
 */
public class StackingFigureContentChainingListener2 extends LookaheadChainingListener
{
     ...
     */
    public StackingFigureContentChainingListener2(ListenerChain listenerChain)
    {
