...
public class EventsChainingRenderer extends AbstractChainingPrintRenderer
{
        ...
        boolean isInline)
    {
        ...
        for (Iterator<Map.Entry<String, String>> paramsIt = parameters.entrySet().iterator(); paramsIt.hasNext();) {
            ...
            parametersBuffer.append(entry.getKey()).append(String.valueOf('=')).append(entry.getValue());
            if (paramsIt.hasNext()) {
                parametersBuffer.append(String.valueOf('|'));
            }
        }
        ...
        macroBuffer.append(String.valueOf(']'));
