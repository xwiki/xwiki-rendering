 ...
 */
@Component
@Named(GroupBlockParser.GROUP)
@Singleton
public class GroupBlockParser extends AbstractBlockParser
{
    /**
    ...
    public void parse(ObjectNode groupBlock, Deque<Context> contextStack) throws ParseException
    {
        ...
        Map<String, String> parameters = getBlockParameters(groupBlock);
        listener.beginGroup(parameters);
        visitChildBlocks(groupBlock, CHILDREN, contextStack);
