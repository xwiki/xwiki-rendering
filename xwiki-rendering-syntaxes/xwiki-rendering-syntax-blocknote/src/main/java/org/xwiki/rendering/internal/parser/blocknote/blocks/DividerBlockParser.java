 ...
 */
@Component
@Named(DividerBlockParser.DIVIDER)
@Singleton
public class DividerBlockParser extends AbstractBlockParser
{
    /**
    ...
    @Override
    public void parse(ObjectNode dividerBlock, Deque<Context> contextStack) throws ParseException
    {
