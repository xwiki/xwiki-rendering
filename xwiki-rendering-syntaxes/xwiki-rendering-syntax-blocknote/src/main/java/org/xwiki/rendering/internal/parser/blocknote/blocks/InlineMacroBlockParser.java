...
/**
 * Inline Macro block parser.
 *
 * @version $Id$
 * @since 18.5.0RC1
 */
@Component
@Named(InlineMacroBlockParser.INLINE_MACRO)
@Singleton
public class InlineMacroBlockParser extends AbstractMacroBlockParser
{
    /**
    ...
    {
        visitMacro(macroBlock, contextStack, true);
    }
}
