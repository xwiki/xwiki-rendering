...
public class HTMLMacroAnnotatedHTML5Renderer extends AbstractChainingPrintRenderer implements Initializable
{
    /**
    ...
    public void initialize() throws InitializationException
    {
        ...
        chain.addListener(new HTMLMacroChainingRenderer(
            new AnnotatedHTML5ChainingRenderer(this.linkRenderer, this.imageRenderer, chain))
        );
    }
}
