 ...
 * @since x.y.z
 */
public class AbstractFigureMacro<T extends FigureMacroParameters> extends AbstractMacro<T>
{
    @Inject
...
//        updateStyleParameters(parameters, figureBlock);
