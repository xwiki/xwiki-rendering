 ...
 */
package org.xwiki.rendering.transformation.linkchecker.script;
...
/**
 * Provides access to the {@link LinkStateManager} for scripts.
 *
 * @version $Id$
 * @since 3.3M1
 */
...
{
    /**
     * The state manager instance to give access to.
     */
    @Inject
